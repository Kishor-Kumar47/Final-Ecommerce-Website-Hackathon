...
const Delivery = () => {
  return (
    <main className='w-[1363px] h-[300px] top-[2463px] bg-[#FAF4F4] gap-5 flex items-center justify-center '>
        {/* section----1 */}
        <div className='w-[376px] h-[108px] top-[2559px] left-[100px]'>
            ...
            <p className='w-[376px] h-[60px] top-[2607px] left-[100px] font-["Poppins"] font-normal text-[20px] leading-[30px] text-[#9F9F9F]'>
            For all oders over $50, consectetur adipim scing elit.
            </p>
        </div>
        {/* section----2 */}
        <div className='w-[376px] h-[108px] top-[2559px] left-[524px]'>
        ...
        {/* section----3 */}
        <div className='w-[376px] h-[108px] top-[2559px] left-[944px]'>
