...
const page = () => {
  return (
    <main>
      ...
      {/* contact */}
      <div className="w-[1363px] h-[760px] top-[416px] flex items-center justify-center ">
        {/* login */}
        <div className="w-[608px] h-[630px] top-[479px] left-[100px] flex flex-col gap-4">
          ...
          <div className="flex items-center mt-10 gap-8">
            <button className="w-[215px] h-[64px] top-[987px] left-[172px] rounded-[15px] border-[1px] border-black text-black ">
              Log In
            </button>
        ...
        <div className="w-[608px] h-[630px] top-[479px] left-[734px] flex flex-col gap-4">
          ...
          <div>
            <h2 className='w-[453px] h-[48px] top-[761px] left-[811px] font-["Poppins"] font-light text-[16px] leading-[24px] text-black'>
              A link to set a new password will be sent to your email address.
            </h2>
            <h2 className='w-[453px] h-[96px] top-[827px] left-[811px] font-["Poppins"] font-light text-[16px] leading-[24px] text-black'>
