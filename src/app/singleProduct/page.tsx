...
const page = () => {
  return (
    <main>
        ...
        {/* section----1...................................................... */}
        <section className='w-[1363px] h-[100px] top-[114px] border border-[2px] border-[#9F9F9F] flex items-center gap-9'>
        ...
        {/* section----2...................................................... */}
        <section className='w-[1363px] h-[802px] top-[211px]'>
            <div className='w-[1200px] h-[730px] top-[246px] left-[99px] flex mt-10'>
                {/* right side */}
                <div className='w-[553px] h-[500px] top-[246px] left-[99px] flex'>
                    ...
                    {/* left  */}
                    <div className='w-[481px] h-[500px] top-[246px] left-[171px] ml-10'>
                        <div className='w-[423px] h-[500px] top-[246px] left-[206px] rounded-[10px] bg-[#FFF9E5]'>
                ...
                <div className='w-[606.01px] h-[730px] top-[246px] left-[734px] ml-10 '>
                    {/* upper side */}
                    <div className='w-[600px] h-[730px] flex flex-col gap-[20px] '>
                        <h2 className='w-[260px] h-[63px] top-[246px] left-[735px] font-["Poppins"] font-normal  text-[42px] leading-[63px] text-black '>Asgaard sofa</h2>
                        <h2 className='w-[173x] h-[36px] top-[309px] left-[735px] font-["Poppins"] font-medium  text-[24px] leading-[36px] text-[#9F9F9F] '>Rs. 250,000.00</h2>
                        ...
                        <h3 className='w-[424px] h-[80px] top-[398px] left-[734px] font-["Poppins"] font-normal  text-[13px] leading-[19.5px] text-black'>
                    ...
                    {/* middel side */}
                    <div className='w-[600px] h-[170px] flex flex-col gap-[20px] '>
                        ...
                        <div className='w-[400px] h-[80px] flex gap-5 mt-4'>
                            ...
                            <div>
                            <button className='w-[215px] h-[64px] top-[676px] left-[735px] rounded-[10px] border-[1px] border-[#9F9F9F] flex  items-center justify-center text-black'>
                                Add To Cart
 ...
 {/* down side */}
                    ...
                    <div className='w-[600px] h-[123px]  border-t-[2px] border-black mt-[90px] flex gap-5 pt-9'>
        ...
        {/* section----3...................................................... */}
        <section className='w-[1363px] h-[777px] top-[1031px] border-[1px] border-[#D9D9D9] flex flex-col items-center gap-8'>
            <div className='w-[649px] h-[36px] top-[1079px] left-[396px] flex'>
                <h3 className='w-[136px] h-[36px] top-[1079px] left-[396px] font-["Poppins"] font-normal  text-[24px] leading-[36px] text-black'>Description</h3>
                <h3 className='w-[269px] h-[36px] top-[1079px] left-[585px] font-["Poppins"] font-normal  text-[24px] leading-[36px] text-[#9F9F9F]'>Additional Information</h3>
                <h3 className='w-[138px] h-[36px] top-[1079px] left-[907px] font-["Poppins"] font-normal  text-[24px] leading-[36px] text-[#9F9F9F]'>Reviews 5</h3>

            </div>
            <div className='w-[1026px] h-[174px] top-[1152px] left-[207px] text-[#9F9F9F] flex flex-col gap-4'>
                <p className='w-[1026px] h-[48px] top-[1152px] left-[207px] font-["Poppins"] font-normal  text-[16px] leading-[24px] text-[#9F9F9F]' >
                Embodying the raw, wayward spirit of rock n roll, the Kilburn portable active stereo speaker takes the unmistakable look and sound of Marshall, unplugs the chords, and takes the show on the road.
                </p>
                <p className='w-[1026px] h-[96px] top-[1230px] left-[207px] font-["Poppins"] font-normal  text-[16px] leading-[24px] text-[#9F9F9F]' >
            ...
            <div className='w-[1239px] h-[348px] top-[1362px] left-[100px] flex justify-between'>
                <div className='w-[605px] h-[348px] top-[1362px] left-[100px] bg-[#FFF9E5]'>
                    <Image
                    src={'/shop-111.png'}
                    width={828}
                    height={551}
